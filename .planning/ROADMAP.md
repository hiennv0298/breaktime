...
- [ ] 01-02-PLAN.md — Boot slice: capability gate, loading bar, Chơi, Rapier SIMD/compat loop, unsupported screen (W2)
...
- [ ] 01-07-PLAN.md — One-command `npm run deploy` orchestration with DNS/smoke helpers (W4)
...
- [ ] 01-10-PLAN.md — Kenney open-space office + pantry, 24+ physics props, blob shadows, highlight + click/E (W5)
- [ ] 01-11-PLAN.md — Debug HUD + auto/manual quality tiers + context-loss handling (W5)
...
- [ ] 01-15-PLAN.md — Slap → slapstick ragdoll → get-up, hit-stop, shake, punch SFX (W7)

**Wave 8** *(blocked on Wave 7 completion)*

- [ ] 01-16-PLAN.md — Breakables with shared shard kit, debris cap by tier, drop/break SFX, smash scenario (W8)
