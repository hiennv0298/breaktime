...
- [x] 02-02-PLAN.md — Logic thuần: hit test tầm/nón, stun người chơi (khoá ≤ 3 s, bất tử 1,5 s), 16 bit nhóm va chạm, điểm đứng dậy (W1)
- [x] 02-03-PLAN.md — Công cụ entry guard D-12 (`scripts/phase-gate-guard.mjs`) + tuyến/điểm xuất phát cho NPC 11–15 (W1)
...
| 2. NPC đồng nghiệp — tên, số lượng, đánh trả | 3/13 | In Progress | - |
